...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    warehouseinfo_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    warehouseinfo_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.042, rely=0.1, height=36, width=455)
        ...
        self.Label1.configure(text='''Please enter the dimensions of the warehouse:''')

        self.Button1 = tk.Button(self.Canvas1)
        self.Button1.place(relx=0.417, rely=0.65, height=33, width=79)
        ...
        self.Label5.place(relx=0.021, rely=0.733, height=34, width=462)
        ...
        self.Canvas2.place(relx=0.104, rely=0.217, relheight=0.405
                , relwidth=0.819)
        ...
        self.Label3.place(relx=0.127, rely=0.658, height=34, width=64)
        ...
        self.Label4 = tk.Label(self.Canvas2)
        self.Label4.place(relx=0.127, rely=0.412, height=34, width=69)
        ...
        self.Label2.place(relx=0.127, rely=0.165, height=34, width=70)
        ...
        self.Entry1.place(relx=0.356, rely=0.206,height=24, relwidth=0.545)
        ...
        self.Entry1_2.place(relx=0.356, rely=0.453,height=24, relwidth=0.545)
        ...
        self.Entry1_4 = tk.Entry(self.Canvas2)
        self.Entry1_4.place(relx=0.356, rely=0.7,height=24, relwidth=0.545)
        ...
        self.Scrolledlistbox1.place(relx=0.208, rely=0.85, relheight=0.045
                , relwidth=0.573)
